<template>
  <div>
    ...
    <section class="line _tc"
             container>
      <h1 class="Intro__title">全尺寸放线</h1>
      <p class="Intro__desc">全尺寸放线作为我们在正式施工第一步，至关重要，它是图纸校验、施工指导、分包商与材料商的量尺依据，
    ...
    <section class="tri-check _tc">
      ...
      <p class="Intro__desc">施工的质量离不开成熟的质量控制体系、我们标准采用高于国际（GB-50203）的企业标准验收依据，
    ...
    <section class="team _tc">
      <h1 class="Intro__title">成熟班组</h1>
      <p class="Intro__desc">施工人员的专业度与项目经理资历是质量体系的基石，
