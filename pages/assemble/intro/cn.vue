<template>
  <div>
    <section class="assemble-top top">
      <div container>
        <h1 class="assemble-top__title">低调优雅，独成天地</h1>
        <h4 class="assemble-top__sub">惊鸿一面</h4>
        <p class="assemble-top__desc">风吹晚灯，杜鹃摇曳
          <br> 一盏茶，一席话，一段情
          <br> 尘世间独留一片方圆，自成天地
          <br> 山水是你的眼帘
          <br> 画与你是我的风景
    ...
    <section class="assemble-space -right hall"
             grid>
      <img src="~assets/img/assemble/cn/hall.jpg"
    ...
    <section class="assemble-space -left dining-room"
      ...
      <img src="~assets/img/assemble/cn/dining-room.jpg"
           class="assemble-space__img"
           alt="cn-dining" />
    </section>
    ...
    <div class="assemble-bg">
      ...
      <section class="assemble-space -right bedroom"
               grid>
        <img src="~assets/img/assemble/cn/bedroom.jpg"
             class="assemble-space__img"
             alt="cn-bedroom" />
        <div class="assemble-space__intro">
          <div class="assemble-space__intro-content">
