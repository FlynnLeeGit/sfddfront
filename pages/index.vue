<template>
  <div>
    ...
    <section class="feature"
      ...
      <h3 v-lazy.animate="['slideInUp']">已为您规划好完整的设计预案，从硬装到软装的造价清单，从制图到全景展示，预案中一应俱全。
    ...
    <section class="standard -design"
      ...
      <img v-lazy.animate="['scale']"
           ...
           alt="01">
      <div class="standard__mask"
           v-lazy.animate="['scale']"></div>
    ...
    <section class="service">
      <div container>
        ...
        <ul class="service__list"
            grid>
          <nuxt-link v-lazy.animate="[ 'slideInUp', 'fade', 'delay'+idx*200 ]"
                     tag='li'
                     class="service__item"
                     :key='s.icon'
                     :to='s.to'
