  ...
  <div>
    ...
    <section class="beauty"
      ...
      <div col
        ...
        <p v-lazy.animate="['slideInUp','fade']">每季度，我们的设计董事带领总监级设计师会推出当季的整装预案，
    ...
    <section class="standard -design"
      ...
      <div class="standard__content">
        <h2 v-lazy.animate="['slideInUp','fade']">整装设计标准</h2>
        <p v-lazy.animate="['slideInUp','fade']">每套整装方案中，我们充分考虑了十二类家具收纳、十条家居动线、六类色彩搭配、核心风格与主打元素。我们基于每个风格，我们会主导三个近似的搭配，并提供软装包（可拆项选择）。帮助您第一时间明确造价、材料、施工内容、设备与软装。</p>
        <nuxt-link v-lazy.animate="['slideInUp','fade']"
                   class="Btn -black"
    ...
    <section class="standard -quality"
      ...
      <div class="standard__mask"
           v-lazy.animate="['scale']"></div>
      <div class="standard__content">
        <h2 v-lazy.animate="['slideInUp','fade']">质量控制标准</h2>
        <p v-lazy.animate="['slideInUp','fade']">我们作为专业的项目总承包商，深谙质量责任之重大，在以下六件事上不敢有半点马虎。自有施工班组成熟稳定、严审制图（深化）精度、先放线后施工、行业领先的工艺要求、稳定成熟的建材配套与尽心尽责的质检管理；并通过我们的协同管理系统，各司其职，统一汇报，为用户提供远超国标的质量标准。</p>
        <nuxt-link v-lazy.animate="['slideInUp','fade']"
                   class="Btn -black"
    ...
    <section class="standard -material"
      ...
      <div class="standard__mask"
           v-lazy.animate="['scale']"></div>
      <div class="standard__content">
        <h2 v-lazy.animate="['slideInUp','fade']">材料选择标准</h2>
        <p v-lazy.animate="['slideInUp','fade']">我们拥有强大的供应链跟严格的供应链考评机制，精选符合设计的国内外一线品牌，从质量稳定、环保、价格、配送及时、安装合规、产能稳定这七个维度，以季度为单位进行评测。采用集采预定的方式对供应商下单，确保我们的采购成本优势能体现在整装预案之内。</p>
        <nuxt-link v-lazy.animate="['slideInUp','fade']"
                   class="Btn -black"
